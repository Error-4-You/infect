# A tool by nitro from www.Error-4-You.com
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn E4Y$red◀$rset"
...
then
am start -a android.intent.action.VIEW -d https://Error-4-You.github.io/noobspage > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.Error-4-You.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Error-4-You/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
